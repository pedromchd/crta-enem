...
export const questoes= [
  ...
  ',
    ...
    //Questão 8 - 143
    {
    enunciado: 'Uma administração municipal encomendou a pintura de dez placas de sinalização para colocar em seu pátio de estacionamento. O profissional contratado para o serviço inicial pintará o fundo de dez placas e cobrará um valor de acordo com a área total dessas placas.  O formato de cada placa é um círculo de diâmetro d = 40 centímetros, que tangencia lados de um retângulo, sendo que o comprimento total da placa é h = 60 centímetros. Use 3,14 como aproximação para pi.Qual a soma das medidas das áreas, em centímetros quadrados, das dez placas?',
    ...
    {
    enunciado: 'Três sócios resolveram fundar uma fábrica. O investimento inicial foi de R$1.000.000,00. E,  independente do valor que cada um investiu nesse primeiro momento, resolveram considerar que cada um deles contribuiu com um terço do investimento inicial. Algum tempo depois, um quarto sócio entrou para a sociedade, e os quatro, juntos, investiram mais R$ 800.000,00 na fábrica. Cada um deles contribui com um quarto desse valor. Quando venderam a fábrica, nenhum outro investimento havia sido feito. Os sócios decidiram então dividir o montante de R$ 1.800.000,00 obtido com a venda, de modo proporcional à quantia total investida por cada sócio. Quais os valores mais próximos, em porcentagens, correspondentes às parcelas financeiras que cada um dos três sócios iniciais e o quarto sócio, respectivamente, receberam?',
  ...
  //Questão 14 - 149
    ...
    //Questão 16 - 151
    {
    enunciado: 'Um estudante de matemática leu a seguinte notícia:Com a ajuda única e exclusiva do seu cérebro, o francês Alexis Lemaire bateu seu próprio recorde de cálculo mental ao resolver a raiz décima terceira de um número de 200 dígitos, escolhido aleatoriamente por um computador. O francês achou a solução correta, dentre 393 trilhões de respostas possíveis.”Para ter uma ideia de quão mínima era a chance de obter esse resultado ao acaso, o estudante decidiu expressar, em notação científica, o número de respostas possíveis.A expressão, em notação científica, obtida pelo estudante foi::',
    ...
    //Questão 17 152
    {
    enunciado: 'A Hydrangea macrophylla é uma planta com flor azul ou cor-de-rosa, dependendo do pH do solo no qual está plantada. Em solo ácido (ou seja, com pH menor que 7) a flor é azul, enquanto que em solo alcalino (ou seja, com pH maior que 7) a flor é rosa. Considere que a Hydrangea cor-de-rosa mais valorizada comercialmente numa determinada região seja aquela produzida em solo com pH inferior a 8. Sabe-se que o pH é igual a: menos log de x na base 10. Em que x é a concentração de íon hidrogênio (H+).Para produzir a Hydrangea cor-de-rosa de maior valor comercial, deve-se preparar o solo de modo que x assuma: ',
...
////////////////////Parei aqui na 52
   ...
   //Questão 18 153
    ...
    //Questão 20 155
    {
    enunciado: 'O preparador físico de um time de basquete dispõe de um plantel de 20 jogadores, com média de altura igual a 1,80 metro. No último treino antes da estreia em um campeonato, um dos jogadores desfalcou o time em razão de uma séria contusão, forçando o técnico a contratar outro jogador para recompor o grupo.Se o novo jogador é 0,20 metros mais baixo que o anterior, qual é a média de altura, em metro, do novo grupo?',
    ...
    {
    enunciado: 'Em uma fábrica de refrigerantes, é necessário que se faça periodicamente o controle no processo de engarrafamento para evitar que sejam envasadas garrafas fora da especificação do volume escrito no rótulo.Diariamente, durante 60 dias, foram anotadas as quantidades de garrafas fora dessas especificações. O resultado está apresentado no quadro.Descrição do quadro: o quadro mostra a quantidade de garrafas fora das especificações por dia e a quantidade de dias:52 dias: 0 garrafa fora das especificações.5 dias: 1 garrafa fora das especificações.2 dias: 2 garrafas fora das especificações.1 dia: 3 garrafas fora das especificações.A média diária de garrafas fora das especificações no período considerado é: ',
    ...
    'A) Fração numerador q e denominador 0,8 vezes m, é maior que 0,4.',
    ...
    alternativas: [
    'A) 2 vezes raiz quadrada de 22 centímetros.',
    'B) 6 vezes raiz quadrada de 3 centímetros.',
    'C) 12 centímetros.',
